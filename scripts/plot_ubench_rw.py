...
ax.legend(["grp_ex", "grp_sh", "Sassy_JSC", "Sassy_JAC_4"], loc = "center left",bbox_to_anchor=(1,0.5),fontsize=14,framealpha=0.5, ncol = 4)
#ax.legend(["grp_ex", "grp_sh", "Sassy_JSC", "Sassy_JAC_4"], loc = "upper left",fontsize=16,framealpha=0.5)
