...
ax.set_ylabel('Load (RPS)',fontsize=20)
ax.set_xlabel('Connection Count',fontsize=20)
#ax.set_ylim(0, 80)
#ax.set_xlim(0, 3)
...
ax.legend(["1k conn, X cores", "12 cores, X*1k conn","128 cores, 128k conn"], loc = "upper left", fontsize=12, framealpha=0.5)#,bbox_to_anchor=(1,0.5),fontsize=14,framealpha=0.5, ncol=4)
...
ax.set_ylabel('Resource\nUtilization (%)',fontsize=20)
ax.set_xlabel('Cores/1k Connections',fontsize=20)
ax.set_ylim(0, 33)
#ax.set_xlim(0, 3)
#ax.set_xscale('log', basex=2)
#ax.set_yscale('log', basey=2)
